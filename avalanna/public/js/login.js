/*window.addEventListener("load", function () {
    ...
    const addErrorP = function(element){
        ...
        const labelContent = document.querySelector(`.login_main_section-input-${element.name} label`).textContent
        errorP.innerText=`"${labelContent.toUpperCase()}" no puede estar vacío`
        divs.forEach(div=>{
            const oldErrorP= document.querySelector(`.error-${element.name}`)
            const rightDiv = document.querySelector(`.login_main_section-input-${element.name}`)
    ...
    const deleteError = function(element){
        ...
        const divFather = document.querySelector(`.login_main_section-input-${element.name}`)        
